...
func TestCreateAttribute(t *testing.T) {
	...
	attribute := CreateAttribute(GenerateRandomID(), GenerateRandomID(), OUT, key, value)
...
func TestIsAttributeEquals(t *testing.T) {
	...
	attribute4 := CreateAttribute(attribute1.ID, GenerateRandomID(), ERR, "test_key", "test_value")
	attribute5 := CreateAttribute(attribute1.ID, GenerateRandomID(), OUT, "test_keyX", "test_value")
...
func TestISAttributeArraysEqual(t *testing.T) {
	...
	attribute4 := CreateAttribute(GenerateRandomID(), GenerateRandomID(), OUT, "test_key", "test_value")
