...
func CreateTestProcessSpec(colonyID string) *core.ProcessSpec {
	return core.CreateProcessSpec("test_image", "test_cmd", []string{"test_arg"}, []string{"test_volumes"}, []string{"test_ports"}, colonyID, []string{}, "test_runtime_type", -1, 3, 1000, 10, 1, make(map[string]string))
}
...
func CreateTestProcessSpecWithType(colonyID string, runtimeType string) *core.ProcessSpec {
	return core.CreateProcessSpec("test_image", "test_cmd", []string{"test_arg"}, []string{"test_volumes"}, []string{"test_ports"}, colonyID, []string{}, runtimeType, -1, 3, 1000, 10, 1, make(map[string]string))
}
...
func CreateTestProcessSpecWithEnv(colonyID string, env map[string]string) *core.ProcessSpec {
	return core.CreateProcessSpec("test_image", "test_cmd", []string{"test_arg"}, []string{"test_volumes"}, []string{"test_ports"}, colonyID, []string{}, "test_runtime_type", -1, 3, 1000, 10, 1, env)
}
...
func CreateTestProcessSpecWithTargets(colonyID string, targetRuntimeIDs []string) *core.ProcessSpec {
	return core.CreateProcessSpec("test_image", "test_cmd", []string{"test_arg"}, []string{"test_volumes"}, []string{"test_ports"}, colonyID, targetRuntimeIDs, "test_runtime_type", -1, 3, 1000, 10, 1, make(map[string]string))
}
