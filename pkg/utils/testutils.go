...
func CreateTestProcessSpec(colonyID string) *core.ProcessSpec {
	return core.CreateProcessSpec("test_name", "test_func", []string{"test_arg"}, colonyID, []string{}, "test_runtime_type", 1000, 10, 1, make(map[string]string), []string{}, 1)
}
...
func CreateTestProcessSpecWithType(colonyID string, runtimeType string) *core.ProcessSpec {
	return core.CreateProcessSpec("test_name", "test_func", []string{"test_arg"}, colonyID, []string{}, runtimeType, 1000, 10, 1, make(map[string]string), []string{}, 1)
}
...
func CreateTestProcessSpecWithEnv(colonyID string, env map[string]string) *core.ProcessSpec {
	return core.CreateProcessSpec("test_name", "test_func", []string{"test_arg"}, colonyID, []string{}, "test_runtime_type", 1000, 10, 1, env, []string{}, 1)
}
...
func CreateTestProcessSpecWithTargets(colonyID string, targetRuntimeIDs []string) *core.ProcessSpec {
	return core.CreateProcessSpec("test_name", "test_func", []string{"test_arg"}, colonyID, targetRuntimeIDs, "test_runtime_type", 1000, 10, 1, make(map[string]string), []string{}, 1)
}
