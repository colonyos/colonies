...
func createFunction() *core.Function {
	return &core.Function{ExecutorID: core.GenerateRandomID(), ColonyID: core.GenerateRandomID(), Name: "testfunc1", Desc: "unit test function", AvgWaitTime: 1.1, AvgExecTime: 0.1, Args: []string{"arg1"}}
}
